...
public class DraggableTab extends Tab {
            ...
            public void handle(MouseEvent t) {
                ...
                if (!t.isStillSincePress()) {
                    ...
                    pane.getTabs().addListener((ListChangeListener<Tab>) change -> {
                        if (pane.getTabs().isEmpty()) newStage.hide();
                    });

                    Scene scene = new Scene(pane);
                    newStage.setScene(scene);
                    newStage.setMinHeight(((VBox) getContent()).getMinHeight());
                    newStage.setMinWidth(((VBox) getContent()).getMinWidth());
                    ResizeHelper.addResizeListener(newStage);
                    newStage.getIcons().add(Main.getIcon());
                    newStage.setX(t.getScreenX());
                    newStage.setY(t.getScreenY());
                    newStage.setTitle(getLabel().getText());
                    newStage.show();
                    pane.requestLayout();
                    pane.requestFocus();
                }
    ...
    public void setStyleClasses(String styleclass) {
        getStyleClass().add(styleclass);
        getLabel().getStyleClass().add(styleclass);
    }
